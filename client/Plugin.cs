...
namespace PostRaidResources
{
    ...
    [BepInPlugin("PostRaidResources.UniqueGUID", "PostRaidResources", "1.0.0")]
    public class Plugin : BaseUnityPlugin
    {
        ...
        private void InjectTreatments()
        {
            ...
            List<GInterface465> treatmentList = (List<GInterface465>)treatmentListField.GetValue(null);
            ...
            treatmentList.Add(new GClass3560()); // Energy
            treatmentList.Add(new GClass3561()); // Hydration
